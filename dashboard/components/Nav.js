import { html, Tip } from './utils.js';

export function Nav({ route, systemInfo, theme, onToggleTheme }) {
    ...
    return html`
        <nav class="border-b px-6 py-3 flex items-center justify-between" style="border-color: var(--border-primary); background: var(--bg-card);">
            <div class="flex items-center gap-6">
                <a href="#/" class="text-lg font-bold tracking-wide" style="color: var(--text-primary);">SWITCHBOARD</a>
