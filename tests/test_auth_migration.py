...
class TestMigrateAuth:
    ...
    def mock_oauth_keys(self):
        """Prevent init_oauth_keys from writing to /data/oauth_rsa_key.pem in tests."""
        with patch("switchboard.auth.oauth.init_oauth_keys", new=MagicMock()):
            yield
