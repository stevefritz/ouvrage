...
log = logging.getLogger("ouvrage.web_push")

from ouvrage.config.settings import VAPID_PRIVATE_KEY, VAPID_PUBLIC_KEY, VAPID_CLAIM_EMAIL
...
async def dispatch_notification(event_type: str, task_id: str, title: str, body: str) -> None:
    ...
    try:
        ...
        payload = {
            ...
            "body": body,
            "tag": f"task-{task_id}",
            "data": {"url": f"/dashboard#/task/{task_id}"},
        }
