...
from ouvrage.db._helpers import now_iso, _strip_embedding, _read_messages, _determine_attempt_outcome
...
async def get_task_attempts(task_id: str) -> list[dict]:
    ...
    for attempt_num in sorted(groups.keys()):
        ...
        from ouvrage.dispatch.lifecycle import get_outcome_definition
