...
from ouvrage.git.providers.base import GitProvider, RepoInfo, PRResult, ValidationResult
...
async def detect_provider(url: str) -> str | None:
    ...
    try:
        from ouvrage.db.git_credentials import get_credential_by_hostname
...
async def resolve_credential(project: dict) -> tuple[GitProvider, str]:
    ...
    from ouvrage.db.git_credentials import get_credential_by_provider
    ...
    if provider_name == "github":
        try:
            from ouvrage.db.users import get_instance_github_pat
