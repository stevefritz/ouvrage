"""SSO endpoint handler for Switchboard.
...
from switchboard.config.settings import AUTH_MODE, CONTROL_PLANE_JWKS, INSTANCE_SLUG
from switchboard.auth.sessions import create_session, _build_session_cookie
from switchboard.db.users import get_user_by_email, create_user, update_user

logger = logging.getLogger("switchboard.auth.sso")
