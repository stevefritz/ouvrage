"""OAuth 2.0 Authorization Server for Switchboard.
...
from switchboard.config.settings import OAUTH_BASE_URL, OAUTH_RSA_KEY_PATH
from switchboard.crypto import encrypt_value, decrypt_value
from switchboard.db.connection import get_db

logger = logging.getLogger("switchboard.auth.oauth")

# ── Constants ─────────────────────────────────────────────────────────────

RSA_KID = "switchboard-1"
...
async def seed_default_client():
    ...
    """
    from switchboard.config.settings import OAUTH_CLIENT_SECRET
